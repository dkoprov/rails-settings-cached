...
In this for namespaces are added to the field to separate settings among, say, locales.

## Status

[![CI Status](https://secure.travis-ci.org/dkoprov/rails-settings-cached.png)](http://travis-ci.org/dkoprov/rails-settings-cached)
